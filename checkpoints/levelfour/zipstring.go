...
// that replaces every character with the number of duplicates and the character 
// itself, deleting the extra duplications.

// - The letters are from the latin alphabet list only. Any other character, 
// symbols, shall not be tested.
